...
class AbsenceRequests(BaseModel):
    absence_request_id: Optional[str] = Field(default=None, description="Absence Request Id")
    ...
    absence_start_date: Optional[date] = Field(default=None, description="Absence Start Date")
    absence_end_date: Optional[date] = Field(default=None, description="Absence End Date")
