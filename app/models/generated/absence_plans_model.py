...
class AbsencePlans(BaseModel):
    ...
    absence_plan_name: Optional[str] = Field(
        default=None, description="Absence Plan Name"
    )
    ...
    annual_entitlement_days: Optional[int] = Field(
        default=None, description="Annual Entitlement Days"
    )
    carryover_allowed: Optional[bool] = Field(
        default=None, description="Carryover Allowed"
    )
    max_carryover_days: Optional[int] = Field(
        default=None, description="Max Carryover Days"
    )
    requires_approval: Optional[bool] = Field(
        default=None, description="Requires Approval"
    )
