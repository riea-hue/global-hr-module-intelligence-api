...
class CompensationGrades(BaseModel):
    ...
    market_reference_zone: Optional[str] = Field(
        default=None, description="Market Reference Zone"
    )
    ...
    geo_differential: Optional[float] = Field(
        default=None, description="Geo Differential"
    )
