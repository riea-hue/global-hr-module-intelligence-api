...
class Candidates(BaseModel):
    ...
    candidate_status: Optional[str] = Field(
        default=None, description="Candidate Status"
    )
    ...
    years_experience: Optional[int] = Field(
        default=None, description="Years Experience"
    )
    education_level: Optional[str] = Field(default=None, description="Education Level")
    gen_ai_skill_signal: Optional[str] = Field(
        default=None, description="Gen Ai Skill Signal"
    )
    willing_to_relocate: Optional[bool] = Field(
        default=None, description="Willing To Relocate"
    )
    requires_work_authorization: Optional[bool] = Field(
        default=None, description="Requires Work Authorization"
    )
    ...
    candidate_consent: Optional[bool] = Field(
        default=None, description="Candidate Consent"
    )
