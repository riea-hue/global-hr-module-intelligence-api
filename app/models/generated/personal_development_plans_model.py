...
class PersonalDevelopmentPlans(BaseModel):
    ...
    career_aspiration: Optional[str] = Field(default=None, description="Career Aspiration")
    development_focus_area: Optional[str] = Field(default=None, description="Development Focus Area")
    development_method: Optional[str] = Field(default=None, description="Development Method")
    promotion_readiness_target: Optional[str] = Field(default=None, description="Promotion Readiness Target")
    mentor_assigned_worker_id: Optional[str] = Field(default=None, description="Mentor Assigned Worker Id")
    ...
    linked_potential_rating: Optional[str] = Field(default=None, description="Linked Potential Rating")
