...
class SupervisoryOrganizations(BaseModel):
    ...
    supervisory_org_name: Optional[str] = Field(default=None, description="Supervisory Org Name")
    parent_supervisory_org_id: Optional[str] = Field(default=None, description="Parent Supervisory Org Id")
