...
class WorkerSkills(BaseModel):
    ...
    proficiency_level: Optional[int] = Field(default=None, description="Proficiency Level")
    ...
    last_assessed_date: Optional[date] = Field(default=None, description="Last Assessed Date")
