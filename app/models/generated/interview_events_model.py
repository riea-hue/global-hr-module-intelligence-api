...
class InterviewEvents(BaseModel):
    interview_event_id: Optional[str] = Field(
        default=None, description="Interview Event Id"
    )
    ...
    interviewer_worker_id: Optional[str] = Field(
        default=None, description="Interviewer Worker Id"
    )
    ...
    gen_ai_assessment_score: Optional[int] = Field(
        default=None, description="Gen Ai Assessment Score"
    )
