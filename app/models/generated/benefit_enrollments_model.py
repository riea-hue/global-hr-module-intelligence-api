...
class BenefitEnrollments(BaseModel):
    benefit_enrollment_id: Optional[str] = Field(default=None, description="Benefit Enrollment Id")
    ...
    employee_contribution_pct: Optional[float] = Field(default=None, description="Employee Contribution Pct")
    employer_contribution_pct: Optional[float] = Field(default=None, description="Employer Contribution Pct")
