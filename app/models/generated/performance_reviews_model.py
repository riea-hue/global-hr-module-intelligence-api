...
class PerformanceReviews(BaseModel):
    ...
    overall_rating_label: Optional[str] = Field(
        default=None, description="Overall Rating Label"
    )
    ...
    gen_ai_readiness: Optional[str] = Field(
        default=None, description="Gen Ai Readiness"
    )
    ...
    calibration_adjustment: Optional[str] = Field(
        default=None, description="Calibration Adjustment"
    )
    review_status: Optional[str] = Field(default=None, description="Review Status")
    review_completion_date: Optional[date] = Field(
        default=None, description="Review Completion Date"
    )
