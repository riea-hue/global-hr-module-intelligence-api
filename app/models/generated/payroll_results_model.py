...
class PayrollResults(BaseModel):
    payroll_result_id: Optional[str] = Field(default=None, description="Payroll Result Id")
    ...
    pay_period_start: Optional[str] = Field(default=None, description="Pay Period Start")
    ...
    tax_withholding: Optional[float] = Field(default=None, description="Tax Withholding")
