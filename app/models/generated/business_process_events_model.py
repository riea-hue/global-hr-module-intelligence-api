...
class BusinessProcessEvents(BaseModel):
    business_process_event_id: Optional[str] = Field(default=None, description="Business Process Event Id")
    ...
    data_change_reason: Optional[str] = Field(default=None, description="Data Change Reason")
    ...
    initiated_by_worker_id: Optional[str] = Field(default=None, description="Initiated By Worker Id")
