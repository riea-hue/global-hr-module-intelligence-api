...
class LearningEnrollments(BaseModel):
    learning_enrollment_id: Optional[str] = Field(
        default=None, description="Learning Enrollment Id"
    )
    worker_id: Optional[str] = Field(default=None, description="Worker Id")
    learning_course_id: Optional[str] = Field(
        default=None, description="Learning Course Id"
    )
    ...
    enrollment_source: Optional[str] = Field(
        default=None, description="Enrollment Source"
    )
    ...
    certification_earned: Optional[bool] = Field(
        default=None, description="Certification Earned"
    )
