...
class JobRequisitions(BaseModel):
    ...
    requisition_title: Optional[str] = Field(
        default=None, description="Requisition Title"
    )
    ...
    hiring_manager_worker_id: Optional[str] = Field(
        default=None, description="Hiring Manager Worker Id"
    )
    recruiter_worker_id: Optional[str] = Field(
        default=None, description="Recruiter Worker Id"
    )
    requisition_status: Optional[str] = Field(
        default=None, description="Requisition Status"
    )
    approval_status: Optional[str] = Field(default=None, description="Approval Status")
    requisition_reason: Optional[str] = Field(
        default=None, description="Requisition Reason"
    )
    ...
    target_start_date: Optional[date] = Field(
        default=None, description="Target Start Date"
    )
    time_to_fill_days: Optional[float] = Field(
        default=None, description="Time To Fill Days"
    )
    primary_recruiting_source: Optional[str] = Field(
        default=None, description="Primary Recruiting Source"
    )
    priority: Optional[str] = Field(default=None, description="Priority")
    gen_ai_critical_requisition: Optional[bool] = Field(
        default=None, description="Gen Ai Critical Requisition"
    )
    confidential_requisition: Optional[bool] = Field(
        default=None, description="Confidential Requisition"
    )
