...
class CriticalRoles(BaseModel):
    critical_role_id: Optional[str] = Field(
        default=None, description="Critical Role Id"
    )
    ...
    criticality_level: Optional[str] = Field(
        default=None, description="Criticality Level"
    )
    business_impact: Optional[str] = Field(default=None, description="Business Impact")
    succession_required_flag: Optional[bool] = Field(
        default=None, description="Succession Required Flag"
    )
    risk_if_vacant: Optional[str] = Field(default=None, description="Risk If Vacant")
    target_successor_count: Optional[int] = Field(
        default=None, description="Target Successor Count"
    )
