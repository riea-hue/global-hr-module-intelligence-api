...
class WorkerCompensation(BaseModel):
    worker_compensation_id: Optional[str] = Field(
        default=None, description="Worker Compensation Id"
    )
    ...
    base_pay_amount: Optional[float] = Field(
        default=None, description="Base Pay Amount"
    )
    base_pay_frequency: Optional[str] = Field(
        default=None, description="Base Pay Frequency"
    )
    ...
    compensation_plan_id: Optional[str] = Field(
        default=None, description="Compensation Plan Id"
    )
    ...
    gen_ai_skill_premium: Optional[float] = Field(
        default=None, description="Gen Ai Skill Premium"
    )
