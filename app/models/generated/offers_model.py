...
class Offers(BaseModel):
    ...
    expected_start_date: Optional[date] = Field(
        default=None, description="Expected Start Date"
    )
    decline_reason: Optional[str] = Field(default=None, description="Decline Reason")
    offered_currency: Optional[str] = Field(
        default=None, description="Offered Currency"
    )
    offered_base_pay_amount: Optional[int] = Field(
        default=None, description="Offered Base Pay Amount"
    )
    offered_base_pay_frequency: Optional[str] = Field(
        default=None, description="Offered Base Pay Frequency"
    )
    sign_on_bonus_amount: Optional[int] = Field(
        default=None, description="Sign On Bonus Amount"
    )
    bonus_target_percentage: Optional[float] = Field(
        default=None, description="Bonus Target Percentage"
    )
    compensation_grade_id: Optional[str] = Field(
        default=None, description="Compensation Grade Id"
    )
    market_position_ratio: Optional[float] = Field(
        default=None, description="Market Position Ratio"
    )
    ...
    gen_ai_premium_amount: Optional[int] = Field(
        default=None, description="Gen Ai Premium Amount"
    )
    avg_interview_score: Optional[float] = Field(
        default=None, description="Avg Interview Score"
    )
    avg_gen_ai_assessment_score: Optional[float] = Field(
        default=None, description="Avg Gen Ai Assessment Score"
    )
    final_recommendation: Optional[str] = Field(
        default=None, description="Final Recommendation"
    )
    completed_interview_count: Optional[int] = Field(
        default=None, description="Completed Interview Count"
    )
