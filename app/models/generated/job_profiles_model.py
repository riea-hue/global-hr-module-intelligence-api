...
class JobProfiles(BaseModel):
    ...
    job_profile_name: Optional[str] = Field(default=None, description="Job Profile Name")
    ...
    is_people_manager_role: Optional[bool] = Field(default=None, description="Is People Manager Role")
