...
from app.models.generated.compensation_grades_model import CompensationGrades
...
def get_compensation_grades(
    ...
    df = load_csv_data("compensation_grades.csv")
...
def get_compensation_grades_by_id(
    ...
    df = load_csv_data("compensation_grades.csv")
    record = df[df["compensation_grade_id"] == record_id]
